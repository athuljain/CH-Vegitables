...
const Home = () => {
  ...
  return (
    <div className="main-wrapper">
      ...
      <section className="carousel-section">
        <Carousel activeIndex={index} onSelect={handleSelect} className="custom-carousel" fade indicators={true}>
          {carouselItems.map((item, idx) => (
            <Carousel.Item key={idx}>
              <div className="carousel-img-container">
                <img src={CHImg3} className="d-block w-100 carousel-img" alt={`Slide ${idx + 1}`} />
              ...
              <Carousel.Caption className="custom-caption">
                <span className="hero-welcome-badge">PREMIUM DISTRIBUTORS</span>
      ...
      <Container className="content-container">
        <section className="cards-section">
          <Row xs={1} md={2} lg={3} className="g-4 justify-content-center">
            {cardData.map((card, idx) => (
              <Col key={idx} className="feature-card-col">
                <Card className="custom-card h-100">
                  <div className="card-img-hover-wrap">
                    <Card.Img variant="top" src={CHImg3} alt={card.title} />
                    <div className="card-img-overlay-tint"></div>
                  </div>
                  ...
                  <Card.Footer className="custom-footer">
                    <span className="footer-gold-star">✦</span> Premium Quality Guaranteed
                  </Card.Footer>
                </Card>
              </Col>
            ))}
      ...
      {/* Seamless Integrated Sub-Components Workflow Layout */}
      <div className="sub-components-layout">
        <section className="home-nested-section bg-trans"><AboutUs /></section>
        <section className="home-nested-section bg-glass-tint"><ServicePage /></section>
        <section className="home-nested-section bg-trans"><Gallery /></section>
        <section className="home-nested-section bg-glass-tint"><ContactUs /></section>
      </div>
    </div>
  );
};
